(function(){
    ...
    var DEFAULT_USER_AVATAR = 'images/default-avatar.png';
    var DEFAULT_QUIZ_THUMB = 'images/quiz-thumb.png';
    var DEFAULT_QUESTION_THUMB = 'images/question-thumb.jpg';

	function MainController($location, identity, auth) {
		var self = this;

        self.defaultAvatar = DEFAULT_USER_AVATAR;
        self.defaultQuizThumb = DEFAULT_QUIZ_THUMB;
        self.defaultQuestionThumb = DEFAULT_QUESTION_THUMB;
